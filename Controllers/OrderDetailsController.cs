...
namespace Marfia_HairTonic.Controllers
{
    public class OrderDetailsController : Controller
    {
        ...
        public OrderDetailsController(HairTonicDbContext context)
        {
            _context = context;
        }
        ...
        {
            var hairTonicDbContext = _context.OrderDetails.Include(o => o.Order).Include(o => o.Product);
            return View(await hairTonicDbContext.ToListAsync());
        }
